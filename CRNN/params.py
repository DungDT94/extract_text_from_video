...
nc = 1
pretrained = '/home/dungdinh/crnn-pytorch/expr/exp3/netCRNN_50.pth'  # path to pretrained model (to continue training)
expr_dir = '/home/dungdinh/crnn-pytorch/expr/exp5'  # where to store samples and models
...
valInterval = 492  # interval to val the model loss and accuray
saveInterval = 299 * 10  # interval to save model
n_val_disp = 10  # number of samples to display when val the model

# finetune
nepoch = 80  # number of epochs to train for
